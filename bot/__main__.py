...
from bot import bot, bot_loop, bot_dict, bot_lock, bot_name, botStartTime, Intervals, user_data, config_dict, scheduler, LOGGER, DATABASE_URL, INCOMPLETE_TASK_NOTIFIER, ARIA_NAME, QBIT_NAME, FFMPEG_NAME, GCLONE_NAME
...
async def restart(_, message: Message):
    ...
    if hrestart:
        ...
        proc1 = await create_subprocess_exec('pkill', '-9', '-f', f'gunicorn|{ARIA_NAME}|{QBIT_NAME}|{FFMPEG_NAME}|{GCLONE_NAME}|java|alass')
